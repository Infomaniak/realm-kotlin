...
object Versions {
    object Android {
        ...
        const val buildTools = "8.13.1" // https://maven.google.com/web/index.html?q=gradle#com.android.tools.build:gradle
        // const val ndkVersion = "29.0.14206865" // TODO: causes lots of errors in C++ and h files
        const val ndkVersion = "27.0.12077973"
        const val r8 = "8.13.17" // See https://developer.android.com/build/kotlin-support
    }
    ...
    const val jmh = "1.37" // https://github.com/openjdk/jmh
    ...
    const val latestKotlin = "2.2.21" // https://kotlinlang.org/docs/eap.html#build-details
    ...
    const val ktor = "2.3.13" // https://github.com/ktorio/ktor
    ...
    const val serialization = "1.9.0" // https://github.com/Kotlin/kotlinx.serialization/releases
