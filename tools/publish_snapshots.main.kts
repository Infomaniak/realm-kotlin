...
val packages: List<String> = File(localMavenRepo, "com/infomaniak/realm/kotlin").listFiles()
...
packages.forEach { packageName ->
    ...
    val versionDirectory = File(localMavenRepo, "com/infomaniak/realm/kotlin/$packageName/$version")
